...
try:
    ...
    print("CTRL C caught, Weather Microservice is now terminating")


#http://api.openweathermap.org/geo/1.0/direct?q={city name},{country code}&&appid=c9f0f6db8b3dc27b6516bc7587ebf93f